 ...
 */
final class Version20250222214959 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fournisseur_stock (fournisseur_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', stock_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_5660E395DCD6110 (stock_id), INDEX IDX_5660E395670C757F (fournisseur_id), PRIMARY KEY(fournisseur_id, stock_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
